...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickButton1() {
        Log.d("test", addBuildInfoToActionName("sdkver23_button1"));
        sendEvent("button", addBuildInfoToActionName("sdkver23_button1"));
    }

    @OnClick(R.id.button2)
    public void onClickButton2(){
        Log.d("test", addBuildInfoToActionName("sdkver23_button2"));
        sendEvent("button", addBuildInfoToActionName("sdkver23_button2"));
    }

    @OnClick(R.id.button3)
    public void onClickButton3(){
        Log.d("test", addBuildInfoToActionName("sdkver23_button3"));
        sendEvent("button", addBuildInfoToActionName("sdkver23_button3"));
    }
